...
public class TestCaseRegister {
	...
	private static void Register(WebDriver driver) throws IOException {
		...
		boolean pass = currentText.equalsIgnoreCase("you have registered, kindly login now");

		if (pass) {
			System.out.println("Test case got passed");
			Utilclass.writeInExcel(System.getProperty("user.dir") + "\\output\\Output.xlsx", "TestCases", 5, 3,
					"Test case got passed");
		} else {
			System.out.println("Test case got failed");
			Utilclass.writeInExcel(System.getProperty("user.dir") + "\\output\\Output.xlsx", "TestCases", 5, 3,"Test case got failed");
		}
