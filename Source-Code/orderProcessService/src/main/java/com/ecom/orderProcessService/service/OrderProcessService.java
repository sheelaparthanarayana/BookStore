...
/** OrderProcessService class takes care of interaction with the Databasen and creates a model */
public class OrderProcessService {
	...
	/**
	 * this method checks and creates account if new account
	 * 
	 * @param accountInfo
	 * @return boolean
	...
	/**
	 * This method check If Account Exists
	 * 
	 * @param userInfo
	...
	/**
	 * This method returns purchase order count
	 * 
	 * @return
	 * @throws OrderProcessServiceException
	 */
